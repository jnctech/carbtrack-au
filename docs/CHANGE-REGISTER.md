...
| CR-260315-hardening | fix/hardening-gaps | SQLite path hardening, *.db gitignore, GitHub Actions (quality gate, scorecard, dependency review, dependabot), SonarCloud project setup. PR #2. | Staged | 2026-03-15 |
