...
| CR-260315-2-staging | feature/2-staging-pipeline | Phase 2: Staging pipeline with conflict detection. 4 endpoints (list, submit, approve, reject), >5% carb variance hold, food_source_refs audit trail. 19 tests. | Staged | 2026-03-15 |
