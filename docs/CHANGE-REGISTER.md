...
| CR-260315-3-query-builder | feature/3-query-builder | Phase 3: Query builder + field mapping (Sonnet integration). 6 new endpoints: construct, sources, map-fields, query-template, staging/map. 30 new tests (84 total), 90% coverage. | Staged | 2026-03-15 |
