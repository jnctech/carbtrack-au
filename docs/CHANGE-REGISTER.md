...
| CR-260315-5a-barcode-ui | feature/5a-barcode-ui | Phase 5A: Mobile-friendly barcode scanning UI. Camera-based EAN-13/UPC-A/EAN-8 via vendored html5-qrcode, manual entry fallback, serving-adjusted carb calculator. Static files served from FastAPI. Route ordering fix for /barcode/{barcode}. 8 new tests (135 total), 91% coverage. | Staged | 2026-03-15 |
